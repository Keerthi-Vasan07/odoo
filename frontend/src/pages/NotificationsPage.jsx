      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
          <div className="max-w-xl mx-auto flex flex-col items-center animate-fade-up">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center mb-8 shadow-[0_0_50px_rgba(236,72,153,0.3)] animate-float">
              <Bell className="w-10 h-10 text-white" />
            </div>
            <div className="page-badge mb-5"><Sparkles className="w-3 h-3" /> Travel Alerts</div>
            <h1 className="t-mega gradient-text mb-5">Notifications</h1>
            <p className="text-gray-400 text-base mb-10 max-w-md leading-relaxed">
              Stay updated on trip invitations, community comments, and upcoming travel alerts.
            </p>
            <div className="px-7 py-3 rounded-2xl glass border border-pink-500/20 mb-8">
